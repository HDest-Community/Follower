...
- Code fixes and improvements by mickromash, Undead_Zeratul
- Additional testing and new followers lines by Faxer


### Changes
- Mod updated to Hideous Destructor v4.14.3d
...
Sprites:
- HyperUltra64: Freylis, Valnos (taken from Bullet-Eye)
- HorrorMovieGuy: Cultist
- Hege Cactus: Daina, Sewie, and Nari. All taken from his mod, La Tailor Girl.

Sounds:
- Blood (Monolith): Cultist Lines
- Heroes of the Storm (Blizzard): Valnos Pain
- Dynasty Warriors 8 (Koei Tecmo): Valnos Death
